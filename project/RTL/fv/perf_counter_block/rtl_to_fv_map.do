...
# Generated on: Sun May 17 17:16:44 PDT 2026 (Mon May 18 00:16:44 UTC 2026)
...
set logfile fv/perf_counter_block/rtl_to_fv_map.log
...
read_implementation_information fv/perf_counter_block -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  perf_counter_block.sv
elaborate_design -golden -root {perf_counter_block} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/perf_counter_block/fv_map.v.gz
elaborate_design -revised -root {perf_counter_block}
...
#add_name_alias fv/perf_counter_block/fv_map.singlebit.original_name.alias.json.gz -revised
