...
# Generated on: Sun May 17 20:15:11 PDT 2026 (Mon May 18 03:15:11 UTC 2026)
...
set logfile fv/tile_buffer_DATA_WIDTH32_TILE_DIM64_NUM_RD_PORTS1/rtl_to_fv_map.log
...
read_implementation_information fv/tile_buffer_DATA_WIDTH32_TILE_DIM64_NUM_RD_PORTS1 -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  tile_buffer.sv
elaborate_design -golden -root {tile_buffer} -rootonly -rootonly  -parameter -int {DATA_WIDTH} "32'sh00000020" -parameter -int {TILE_DIM} "32'sh00000040" -parameter -int {NUM_RD_PORTS} "32'sh00000001"

read_design -verilog95   -revised -lastmod -noelab fv/tile_buffer_DATA_WIDTH32_TILE_DIM64_NUM_RD_PORTS1/fv_map.v.gz
elaborate_design -revised -root {tile_buffer_DATA_WIDTH32_TILE_DIM64_NUM_RD_PORTS1}
...
#add_name_alias fv/tile_buffer_DATA_WIDTH32_TILE_DIM64_NUM_RD_PORTS1/fv_map.singlebit.original_name.alias.json.gz -revised
