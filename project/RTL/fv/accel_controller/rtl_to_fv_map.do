...
# Generated on: Sun May 17 17:13:48 PDT 2026 (Mon May 18 00:13:48 UTC 2026)
...
set logfile fv/accel_controller/rtl_to_fv_map.log
...
read_implementation_information fv/accel_controller -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  accel_controller.sv
elaborate_design -golden -root {accel_controller} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/accel_controller/fv_map.v.gz
elaborate_design -revised -root {accel_controller}
...
#add_name_alias fv/accel_controller/fv_map.singlebit.original_name.alias.json.gz -revised
