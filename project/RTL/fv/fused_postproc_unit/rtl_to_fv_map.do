...
# Generated on: Sun May 17 15:51:44 PDT 2026 (Sun May 17 22:51:44 UTC 2026)
...
set logfile fv/fused_postproc_unit/rtl_to_fv_map.log
...
read_implementation_information fv/fused_postproc_unit -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  gelu_unit.sv
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  gelu_grad_unit.sv
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  fused_postproc_unit.sv
elaborate_design -golden -root {fused_postproc_unit} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/fused_postproc_unit/fv_map.v.gz
elaborate_design -revised -root {fused_postproc_unit}
...
#add_name_alias fv/fused_postproc_unit/fv_map.singlebit.original_name.alias.json.gz -revised
