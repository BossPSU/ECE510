...
# Generated on: Sun May 17 05:11:04 PDT 2026 (Sun May 17 12:11:04 UTC 2026)
...
set logfile fv/softmax_unit_DATA_WIDTH32_VEC_LEN64/rtl_to_fv_map.log
...
read_implementation_information fv/softmax_unit_DATA_WIDTH32_VEC_LEN64 -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  softmax_unit.sv
elaborate_design -golden -root {softmax_unit} -rootonly -rootonly  -parameter -int {DATA_WIDTH} "32'sh00000020" -parameter -int {VEC_LEN} "32'sh00000040"

read_design -verilog95   -revised -lastmod -noelab fv/softmax_unit_DATA_WIDTH32_VEC_LEN64/fv_map.v.gz
elaborate_design -revised -root {softmax_unit_DATA_WIDTH32_VEC_LEN64}
...
#add_name_alias fv/softmax_unit_DATA_WIDTH32_VEC_LEN64/fv_map.singlebit.original_name.alias.json.gz -revised
