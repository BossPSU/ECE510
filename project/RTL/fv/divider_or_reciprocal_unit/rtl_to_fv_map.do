...
# Generated on: Sun May 17 14:10:27 PDT 2026 (Sun May 17 21:10:27 UTC 2026)
...
set logfile fv/divider_or_reciprocal_unit/rtl_to_fv_map.log
...
read_implementation_information fv/divider_or_reciprocal_unit -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  divider_or_reciprocal_unit.sv
elaborate_design -golden -root {divider_or_reciprocal_unit} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/divider_or_reciprocal_unit/fv_map.v.gz
elaborate_design -revised -root {divider_or_reciprocal_unit}
...
#add_name_alias fv/divider_or_reciprocal_unit/fv_map.singlebit.original_name.alias.json.gz -revised
