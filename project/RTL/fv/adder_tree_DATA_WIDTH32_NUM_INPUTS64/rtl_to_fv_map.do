...
# Generated on: Sun May 17 15:24:02 PDT 2026 (Sun May 17 22:24:02 UTC 2026)
...
set logfile fv/adder_tree_DATA_WIDTH32_NUM_INPUTS64/rtl_to_fv_map.log
...
read_implementation_information fv/adder_tree_DATA_WIDTH32_NUM_INPUTS64 -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  adder_tree.sv
elaborate_design -golden -root {adder_tree} -rootonly -rootonly  -parameter -int {DATA_WIDTH} "32'sh00000020" -parameter -int {NUM_INPUTS} "32'sh00000040"

read_design -verilog95   -revised -lastmod -noelab fv/adder_tree_DATA_WIDTH32_NUM_INPUTS64/fv_map.v.gz
elaborate_design -revised -root {adder_tree_DATA_WIDTH32_NUM_INPUTS64}
...
#add_name_alias fv/adder_tree_DATA_WIDTH32_NUM_INPUTS64/fv_map.singlebit.original_name.alias.json.gz -revised
