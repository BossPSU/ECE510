...
# Generated on: Sat May 16 18:48:33 PDT 2026 (Sun May 17 01:48:33 UTC 2026)
...
set logfile fv/systolic_array_64x64_ROWS32_COLS32_DATA_WIDTH32/rtl_to_fv_map.log
...
read_implementation_information fv/systolic_array_64x64_ROWS32_COLS32_DATA_WIDTH32 -revised fv_map
...
add_search_path . $env(LIB_PATH) -library -both
read_library -liberty -both \
    /pkgs/synopsys/2020/32_28nm/SAED32_EDK/lib/stdcell_rvt/db_nldm/saed32rvt_tt0p85v25c.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  accel_pkg.sv
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  mac_pe.sv
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  systolic_array_64x64.sv
elaborate_design -golden -root {systolic_array_64x64} -rootonly -rootonly  -parameter -int {ROWS} "32'sh00000020" -parameter -int {COLS} "32'sh00000020" -parameter -int {DATA_WIDTH} "32'sh00000020"

read_design -verilog95   -revised -lastmod -noelab fv/systolic_array_64x64_ROWS32_COLS32_DATA_WIDTH32/fv_map.v.gz
elaborate_design -revised -root {systolic_array_64x64_ROWS32_COLS32_DATA_WIDTH32}
...
#add_name_alias fv/systolic_array_64x64_ROWS32_COLS32_DATA_WIDTH32/fv_map.singlebit.original_name.alias.json.gz -revised
