...
# Generated on: Sat May 16 15:51:13 PDT 2026 (Sat May 16 22:51:13 UTC 2026)
...
set logfile fv/systolic_array_64x64_ROWS4_COLS4_DATA_WIDTH32/rtl_to_fv_map.log
...
read_implementation_information fv/systolic_array_64x64_ROWS4_COLS4_DATA_WIDTH32 -revised fv_map
...
elaborate_design -golden -root {systolic_array_64x64} -rootonly -rootonly  -parameter -int {ROWS} "32'sh00000004" -parameter -int {COLS} "32'sh00000004" -parameter -int {DATA_WIDTH} "32'sh00000020"

read_design -verilog95   -revised -lastmod -noelab fv/systolic_array_64x64_ROWS4_COLS4_DATA_WIDTH32/fv_map.v.gz
elaborate_design -revised -root {systolic_array_64x64_ROWS4_COLS4_DATA_WIDTH32}
...
#add_name_alias fv/systolic_array_64x64_ROWS4_COLS4_DATA_WIDTH32/fv_map.singlebit.original_name.alias.json.gz -revised
