...
# Generated on: Sun May 17 13:51:41 PDT 2026 (Sun May 17 20:51:41 UTC 2026)
...
set logfile fv/causal_mask_unit/rtl_to_fv_map.log
...
read_implementation_information fv/causal_mask_unit -revised fv_map
...
delete_search_path -all -design -golden
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  causal_mask_unit.sv
elaborate_design -golden -root {causal_mask_unit} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/causal_mask_unit/fv_map.v.gz
elaborate_design -revised -root {causal_mask_unit}
