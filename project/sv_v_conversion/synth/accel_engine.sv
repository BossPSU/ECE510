...
(
  ...
  // M3-synth scope-down: pull TILE_DIM from the (scoped) accel_pkg::TILE_SIZE
  // instead of hardcoding 64. Source: project/m2/rtl/accel_engine.sv with this
  // single line changed. See project/m3/synth/accel_pkg.sv for the value.
  localparam int TILE_DIM = TILE_SIZE;
